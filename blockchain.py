...
class Blockchain(object):
    ...
    def __init__(self):
        # stores other nodes in the network
        self.nodes = set()

        # stores all blocks in the entire blockchain
        self.chain = []

        # temporarily stores the transactions of the current block
        self.current_transactions = []

        # create the genesis block with a specific fixed hash of
        # previous block, genesis block starts with index 0
    ...
    def add_node(self, address):
        ...
        print(f'Added {parsed_url.netloc} to nodes')
    ...
    def valid_proof(self, index, hash_of_previous_block, transactions, nonce):
        ...
        # check if the hash meet the difficulty target
...
def mine_block():
    ...
    # obtain the has of the last block in the blockchain
    ...
    # add the new block to the blockchain using the last block hash and
    # the current nonce
...
def add_nodes():
    ...
    values = request.get_json()
    # gets nodes or Nones from the dictionary
